"""
Diagnostic script for LaunchPAD WAHB.
"""
...
def plot_WAHB(ds_data, expt):
    ...
    for counter, Cube1 in enumerate(Cube0.slices(["latitude", "longitude"])):
        ...
        cf = current_ax.contourf(
            xm, ym, np.array(Cube1.data), clevs_hb, colors=arr_hb, extend="both"
        )
...
if __name__ == "__main__":
    ...
    with run_diagnostic() as config:
        ...
        for ds in data_for_plotting.keys():
            plot_WAHB(data_for_plotting[ds], ds)
